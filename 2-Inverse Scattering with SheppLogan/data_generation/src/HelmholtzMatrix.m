...
switch type
    ...
    case 'DEBUG'
        a =  -omega^2*M;
        b1 = spdiags(-I/(omega*(npml-1)*h)*sxp(:)./(1-I/omega*sx(:)).^3,0,n,n);
        b2 = Dx;
        c1 = spdiags(-I/(omega*(npml-1)*h)*syp(:)./(1-I/omega*sy(:)).^3,0,n,n);
        c2 = Dy;
        d1 = spdiags(1./(1-I/omega*sx(:)).^2,0,n,n);
        d2 = Dxx;
        e1 = spdiags(1./(1-I/omega*sy(:)).^2,0,n,n);
        e2 = Dyy; 
